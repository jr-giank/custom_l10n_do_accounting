...
class L10nDOTestsCommon(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref="l10n_do.do_chart_template"):
        ...
        cls.do_document_type = {
            "fiscal": cls.env.ref("custom_l10n_do_accounting.ncf_fiscal_client"),
            "consumer": cls.env.ref("custom_l10n_do_accounting.ncf_consumer_supplier"),
            "debit_note": cls.env.ref("custom_l10n_do_accounting.ncf_debit_note_client"),
            "credit_note": cls.env.ref("custom_l10n_do_accounting.ncf_credit_note_client"),
            "informal": cls.env.ref("custom_l10n_do_accounting.ncf_informal_supplier"),
            "unique": cls.env.ref("custom_l10n_do_accounting.ncf_unique_client"),
            "minor": cls.env.ref("custom_l10n_do_accounting.ncf_minor_supplier"),
            "special": cls.env.ref("custom_l10n_do_accounting.ncf_special_client"),
            "governmental": cls.env.ref("custom_l10n_do_accounting.ncf_gov_client"),
            "export": cls.env.ref("custom_l10n_do_accounting.ncf_export_client"),
            "exterior": cls.env.ref("custom_l10n_do_accounting.ncf_exterior_supplier"),
            "e-fiscal": cls.env.ref("custom_l10n_do_accounting.ecf_fiscal_client"),
            "e-consumer": cls.env.ref("custom_l10n_do_accounting.ecf_consumer_supplier"),
            "e-debit_note": cls.env.ref("custom_l10n_do_accounting.ecf_debit_note_client"),
            "e-credit_note": cls.env.ref("custom_l10n_do_accounting.ecf_credit_note_client"),
            "e-informal": cls.env.ref("custom_l10n_do_accounting.ecf_informal_supplier"),
            "e-minor": cls.env.ref("custom_l10n_do_accounting.ecf_minor_supplier"),
            "e-special": cls.env.ref("custom_l10n_do_accounting.ecf_special_client"),
            "e-governmental": cls.env.ref("custom_l10n_do_accounting.ecf_gov_client"),
            "e-export": cls.env.ref("custom_l10n_do_accounting.ecf_export_client"),
            "e-exterior": cls.env.ref("custom_l10n_do_accounting.ecf_exterior_supplier"),
        }
